...
void GK_searchPQ(ZZ &p, ZZ &q)
{
    do
    {
        do
        {
            p = middleSquareNumber(get_semilla(),ZZ(1024));
        ...
        do
        {
            q = middleSquareNumber(get_semilla(),ZZ(1024));
            //q = rand()%100000;
            //q = rand();
...
ZZ GK_searchE(ZZ fhi)
{
    ...
    do
    {
        e = middleSquareNumber(get_semilla(),ZZ(1024));
        //e = rand()%1000;
        //e = rand();
...
string cypher(string mensaje_cifrado, ZZ e_R, ZZ n_R, string mensaje, string alfabeto){
    ...
    for (int i = 0; i < i_fin_temp2; ++i){
        ...
        ZZ total_number_digits = NumberOfDigitsZZ(n_R); //hacer que sea de tamaño N
...
string cypher_rubrica(ZZ d_E, ZZ n_E, string alfabeto){
    ...
    for (int i = 0; i < rubrica_temp2; ++i){
        ...
        ZZ total_number_digits = NumberOfDigitsZZ(n_E); //hacer que sea de tamaño N
...
string cypher_firma(string rubrica_r, ZZ e_R, ZZ n_R, string alfabeto){
    ...
    for (int i = 0; i < i_fin_temp2; ++i){
        ...
        ZZ total_number_digits = NumberOfDigitsZZ(n_R); //HACER QUE SEA DEL TAMAÑO DE n
